-- =====================================================
-- SCRIPT DE PRODUCCIÓN — Sistema ERP Punto de Venta
...
INSERT INTO `tc_categorias` VALUES (1,'Tienda'),(2,'Farmacia'),(3,'General');
...
INSERT INTO `tc_menus` VALUES
  (1,  'Dashboard',       'dashboard',                 '/dashboard',       1,  NULL, 1, 'dashboard'),
  (52, 'Ventas',          'point_of_sale',             '/ventas',          2,  NULL, 1, 'ventas'),
  (46, 'Caja',            'account_balance_wallet',    '/caja',            3,  NULL, 1, 'cajas'),
  (49, 'Pedidos',         'shopping_cart',             '/pedidos',         4,  NULL, 1, 'pedidos'),
  (42, 'Clientes',        'people',                    '/clientes',        5,  NULL, 1, 'clientes'),
  (43, 'Proveedores',     'local_shipping',            '/proveedores',     6,  NULL, 1, 'proveedores'),
  (6,  'Inventario',      'inventory',                 '/inventario',      7,  NULL, 1, 'inventario'),
  ...
  (37, 'Configuración',   'settings',                  '/configuracion',   8,  NULL, 1, 'configuracion'),
  (31, 'Sucursales',      'store',                     '/sucursales',      1,  37,   1, 'sucursales'),
  (38, 'Usuarios',        'manage_accounts',           '/usuarios',        2,  37,   1, 'usuarios'),
  (39, 'Roles',           'admin_panel_settings',      '/roles',           3,  37,   1, 'roles'),
  (50, 'Flujo de Pedidos','tune',                      '/pedidos/config',  4,  37,   1, 'pedidos_config');
...
CREATE TABLE `tc_pedidos_config` (
  ...
  `permite_parcial` tinyint(1) DEFAULT '1',
  `permite_bonificacion` tinyint(1) DEFAULT '1',
  `flujo` varchar(50) DEFAULT 'despacho',
...
INSERT INTO `tc_sucursales` VALUES (1,'Central','Dirección Principal','00000000',1,NOW());

-- =====================================================
-- TABLAS DE SEGURIDAD (ts_)
-- =====================================================
...
CREATE TABLE `ts_permisos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `rol_menu` (`rol_id`,`menu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Permisos: Rol 1 (Administrador) - acceso total
INSERT INTO `ts_permisos` (rol_id, menu_id, puede_ver, puede_crear, puede_editar, puede_eliminar) VALUES
  (1,1,1,1,1,1),(1,6,1,1,1,1),(1,7,1,1,1,1),(1,8,1,1,1,1),
  (1,31,1,1,1,1),(1,37,1,1,1,1),(1,38,1,1,1,1),(1,39,1,1,1,1),
  (1,42,1,1,1,1),(1,43,1,1,1,1),(1,46,1,1,1,1),(1,49,1,1,1,1),
  (1,50,1,1,1,1),(1,51,1,1,1,1),(1,52,1,1,1,1),
-- Rol 2 (Cajero) - ventas, caja, clientes
...
CREATE TABLE `tt_arqueos_caja` (
  ...
  `tipo` enum('apertura','cierre') DEFAULT NULL,
...
INSERT INTO `tt_bodegas` VALUES (1,1,'Bodega Principal');
...
INSERT INTO `tt_cajas` VALUES (1,1,'Caja 1','cerrada',0.00,0.00,NULL,NULL,NULL,NULL);
...
CREATE TABLE `tt_existencias` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `prod_bodega` (`producto_id`,`bodega_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tt_personas` (
  ...
  `telefono` varchar(20) DEFAULT NULL,
  `direccion` varchar(200) DEFAULT NULL,
  `tipo` enum('cliente','proveedor','empleado','paciente','medico') DEFAULT 'cliente',
  `email` varchar(100) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `tt_personas` VALUES (1,'Consumidor Final','CF',NULL,NULL,'cliente',NULL,NOW());
...
CREATE TABLE `tt_productos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(150) NOT NULL,
  `tipo` enum('producto','servicio','medicamento') DEFAULT 'producto',
...
-- Usuario admin por defecto: usuario=admin / password=Admin2024!
-- Hash bcrypt de "Admin2024!"
INSERT INTO `tt_usuarios` VALUES
  (1,'Administrador','admin','$2a$10$mUmwKR73xXTvJHbkDcUdEesLEhunDOA.3.CazPXYZA3mwcLqKsufO',1,1,1,NOW());
